...
- **Milestone 3.5: Minimalist Desktop GUI Overhaul & Onboarding (`v0.5.15` - `v0.5.17`)** — Shipped 🚀 (T3 Code-inspired visual diff center, lightweight custom diff engine, CLI dependency assistant, re-triggerable onboarding, external editor launch, native drag regions)
