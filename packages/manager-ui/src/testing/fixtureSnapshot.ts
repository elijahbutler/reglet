...
export const managerFixtureSnapshot: ManagerSnapshotV3 = {
  ...
  providers: [
    { id: 'codex', displayName: 'Codex', detected: true, documentationUrl: 'https://developers.openai.com/codex/', lastVerifiedAt: '2026-07-31', schemaVersion: 1, capabilities: { instructions: { supported: true }, skills: { supported: true }, mcp: { supported: true } }, sources: [], projections: [] },
    { id: 'claude', displayName: 'Claude Code', detected: true, documentationUrl: 'https://docs.anthropic.com/', lastVerifiedAt: '2026-07-31', schemaVersion: 1, capabilities: { instructions: { supported: true }, skills: { supported: true }, mcp: { supported: true } }, sources: [], projections: [] },
    { id: 'cursor', displayName: 'Cursor', detected: true, documentationUrl: 'https://docs.cursor.com/', lastVerifiedAt: '2026-07-31', schemaVersion: 1, capabilities: { instructions: { supported: true }, skills: { supported: true }, mcp: { supported: true } }, sources: [], projections: [] },
    { id: 'gemini', displayName: 'Gemini CLI', detected: true, documentationUrl: 'https://github.com/google-gemini/gemini-cli', lastVerifiedAt: '2026-07-31', schemaVersion: 1, capabilities: { instructions: { supported: true }, skills: { supported: true }, mcp: { supported: true } }, sources: [], projections: [] },
    { id: 'windsurf', displayName: 'Windsurf', detected: false, documentationUrl: 'https://docs.windsurf.com/', lastVerifiedAt: '2026-07-31', schemaVersion: 1, capabilities: { instructions: { supported: true }, skills: { supported: false, issue: 'Global skill projection is not verified.' }, mcp: { supported: true } }, sources: [], projections: [] },
    { id: 'opencode', displayName: 'OpenCode', detected: true, documentationUrl: 'https://opencode.ai/docs/', lastVerifiedAt: '2026-07-31', schemaVersion: 1, capabilities: { instructions: { supported: true }, skills: { supported: true }, mcp: { supported: true } }, sources: [], projections: [] },
  ],
  projectInbox: { roots: [], discoveries: [] },
  activity: [],
  settings: {
    setup: { completed: true },
    sync: { enabled: false, phase: 'disabled', state: 'disabled', conflictCount: 0, conflicts: [] },
